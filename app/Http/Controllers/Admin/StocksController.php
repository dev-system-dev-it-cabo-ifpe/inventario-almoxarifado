...
class StocksController extends Controller
{
    ...
    public function create()
    {
        ...
        $assets = Asset::all()->pluck('codigo', 'id')->prepend(trans('global.pleaseSelect'), '');
        #$names = Asset::all()->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
        $teams = Team::all()->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.stocks.create', compact('assets','teams'));
    }
    ...
    public function edit(Stock $stock)
    {
        ...
        return view('admin.stocks.edit', compact('assets','teams', 'stock'));
    }
