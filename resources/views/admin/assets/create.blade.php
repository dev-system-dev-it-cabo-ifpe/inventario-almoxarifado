    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.assets.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.asset.fields.balancete') }}</label>
                <input class="form-control {{ $errors->has('balancete') ? 'is-invalid' : '' }}" type="text" name="balancete" id="balancete" value="{{ old('balancete', '') }}" required>
            ...
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.asset.fields.codigo') }}</label>
