    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.stocks.update", [$stock->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('asset') ? 'is-invalid' : '' }}" name="asset_id" id="asset_id" value="{{ old('asset_id', $stock->asset_id) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('suap_stock') ? 'is-invalid' : '' }}" type="number" name="suap_stock" id="suap_stock" value="{{ old('suap_stock', $stock->suap_stock) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('inventario_stock') ? 'is-invalid' : '' }}" type="number" name="inventario_stock" id="inventario_stock" value="{{ old('inventario_stock', $stock->inventario_stock) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_inventario') ? 'is-invalid' : '' }}" type="date" name="data_inventario" id="data_inventario" value="{{ old('data_inventario', $stock->data_inventario) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_suap') ? 'is-invalid' : '' }}" type="date" name="data_suap" id="data_suap" value="{{ old('data_suap', $stock->data_suap) }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('team') ? 'is-invalid' : '' }}" name="team_id" id="team_id" value="{{ old('team_id', $stock->team_id) }}" >
